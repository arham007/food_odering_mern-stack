        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
            <div style={{ width: "70%", maxHeight: "100%", border: "1px solid rgba(0,47,52,.2)", borderRadius: "5px", padding: "5px 30px" }}>
                ...
                <div >
                    ...
                    <input placeholder="Ad title" onChange={(e) => setName(e.target.value)} required id="standard-required" label="Ad title " fullWidth name="title" style={{ width: "100%", border: "none", borderBottom: "2px solid gray", margin: "20px 0", padding: "10px", fontSize: "14px" }} />
                    <hr />
                    <FormControl className="w-75 text-center" onChange={(e) => setCategory(e.target.value)}  >
                    ...
                    <hr />
                    <TextareaAutosize onChange={(e) => setDesc(e.target.value)} className="w-100 mt-4" style={{ fontSize: "14px", padding: "10px" }} rowsMin={3} aria-label="empty textarea" placeholder="Detail" name="detail" />
                </div>
                <hr />
                <div><h6 style={{ fontWeight: "bolder", textTransform: "capitalize", color: "#002f34", fontSize: "14px" }}>SET A PRICE</h6></div>
                <input onChange={(e)=> setPrice(e.target.value)} placeholder="Price" style={{ fontSize: "14px", width: "100%", border: "none", borderBottom: "2px solid gray", padding: "10px", fontSize: "14px" }} required id="standard-required" label="Price " type="number" fullWidth name="price" />
                ...
                <div onClick={handleChange}  style={{ margin: '15px 0px', marginTop: "20px" }}>
                    <button style={{ padding: "14px ", width: "30%", backgroundColor: "#FE5F1E", outline: "none", border: "none", fontSize: "14px", color: "#fff" }}>Submit</button>
                </div>
